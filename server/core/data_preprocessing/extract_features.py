...
def extract_features(vocab):
    ...
    df0 = pd.read_csv(
        "./server/core/data_preprocessing/splitted_data_0.csv").loc[:,
          ["id", "message+desc", "class_label"]]
    df1 = pd.read_csv(
        "./server/core/data_preprocessing/splitted_data_1.csv").loc[:,
          ["id", "message+desc", "class_label"]]
    df2 = pd.read_csv(
        "./server/core/data_preprocessing/splitted_data_2.csv").loc[:,
          ["id", "message+desc", "class_label"]]
    df3 = pd.read_csv(
        "./server/core/data_preprocessing/splitted_data_3.csv").loc[:,
          ["id", "message+desc", "class_label"]]
    df4 = pd.read_csv(
        "./server/core/data_preprocessing/splitted_data_4.csv").loc[:,
          ["id", "message+desc", "class_label"]]
